...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($username != '' && $password != '') {
        $sql = "SELECT * FROM tbl_contact WHERE username='$username' AND password='$password'";
...
<div class="navbar">
    ...
    <form method="post" action="#">
        <table>
            ...
            <tr>
                 <td><p>Dont have an Account? <a href="register.php" style="text-decoration:none; color: #1a8cff; text-align:center;">Register</a></p></td>
            </tr>
            <tr>
                <td></td>
